...
head_n = st.number_input("Número de Linhas", value=10, max_value = data.shape[0])
st.dataframe(data[cols].head(head_n))
...
# quando o botão é pressionado = True
...
if btn_predict:
    ...
    #Side Bar
    st.sidebar.header("O valor previsto para o imóvel é:")
